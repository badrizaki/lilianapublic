...
// 	echo "ini path = " . $_SERVER['DOCUMENT_ROOT'];die;
	$config['img_path'] = '/files/images'; // Relative to domain name
// 	$config['upload_path'] = 'C:\xampp\htdocs\project\minnapadi\public' . $config['img_path']; // Physical path. [Usually works fine like this]
// 	$config['public_url'] = 'http://localhost/project/minnapadi/public'; // Relative to domain name
	$config['public_url'] = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/minnapadi'; // Relative to domain name
	// $config['upload_path'] = 'C:\xampp\htdocs\project\marguna\public'; // Physical path. [Usually works fine like this]
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . '/minnapadi' . $config['img_path']; // Physical path. [Usually works fine like this]
