...
$tinybrowser['path']['image'] = '/assets/gallery/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/assets/media/'; // Media files location
$tinybrowser['path']['file']  = '/assets/files/'; // Other files location
...
$tinybrowser['link']['image'] = $_SESSION['base_url'].$tinybrowser['path']['image']; // Image links
