        ...
        (o.prototype.enable = function () {
            this.enabled ||
                ...
                this.orientationSupport
                    ? ((this.portrait = null), i.addEventListener("deviceorientation", this.onDeviceOrientation), setTimeout(this.onOrientationTimer, this.supportDelay))
                    : ((this.cx = 0), (this.cy = 0), (this.portrait = !1), i.addEventListener("mousemove", this.onMouseMove)),
